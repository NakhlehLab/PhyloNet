 ...
 */
@CommandName("InferNetwork_ParentalTrees")
public class InferNetwork_ParentalTrees extends CommandBaseFileOut {

    List<Tree> _treeSet = new ArrayList<>();

    public InferNetwork_ParentalTrees(SyntaxCommand motivatingCommand, ArrayList<Parameter> params, Map<String, NetworkNonEmpty> sourceIdentToNetwork, Proc3<String, Integer, Integer> errorDetected,
