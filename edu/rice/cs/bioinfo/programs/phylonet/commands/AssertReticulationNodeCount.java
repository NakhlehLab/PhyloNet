...
public class AssertReticulationNodeCount extends CommandBase
{
    ...
    public AssertReticulationNodeCount(SyntaxCommand motivatingCommand, ArrayList<Parameter> params, Map<String, NetworkNonEmpty> sourceIdentToNetwork, Proc3<String, Integer, Integer> errorDetected) {
