...
public class SubtreePruneAndRegraft extends HeuristicTreeSearchBase
{
    ...
    protected String produceResult() {
        ...
        SPRSearcherNeighborsExpansiveInPlace spr = new SPRSearcherNeighborsExpansiveInPlace(isTreeRooted, isDestinationNode, getNodes, getEdges, getIncidentEdges, getNodesOfEdge, removeEdge, addNode, removeNode,
                                                                                            addEdge, makeEdge, makeNode, getEdgesReachaleFromNode);




        spr.search(inputTree, scoreTree, isScoreBetter, numIters);
