 ...
 */
@CommandName("MCMC_SEQ2")
public class MCMC_SEQ2 extends CommandBaseFileOutMultilocusData {
    ...
    public MCMC_SEQ2(SyntaxCommand motivatingCommand, ArrayList<Parameter> params,
