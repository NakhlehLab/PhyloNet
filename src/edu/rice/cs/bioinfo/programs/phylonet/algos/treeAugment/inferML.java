...
public class inferML{
    ...
    protected int _returnNetworks = 5;
...
//    }
    ...
    public void inferML(String gtPath, String stPath, String mapfile){
    }
...
//    }
    ...
    public String produceResult(String gtPath, String stPath, String mapfile, String outgroupG, String outgroupS, int mode){
        ...
        InferNetworkMLFromGT inference = new InferNetworkMLFromGTT_SingleTreePerLocus();
//        int [] acceptCount = new int[6];
        inference.setSearchParameter(_maxRounds, _maxTryPerBranch, _improvementThreshold, _maxBranchLength, _Brent1, _Brent2, _maxExaminations, _maxFailure, _moveDiameter, _reticulationDiameter, _parallel, speciesNetwork, _fixedHybrid, _operationWeight, _numRuns, _optimizeBL, _seed);
        LinkedList<Tuple<Network, Double>> resultTuples = new LinkedList<>();
        inference.inferNetwork(gts,_taxonMap, _maxReticulations, _returnNetworks, _postOptimization, resultTuples);
...
//    }
    ...
    public static void RunOnceLocalPLMode(int mode){
        String path = "/Users/zhen/Desktop/Zhen/research/phylogenetics/scalablePhylogeneticNetworkInference/proj/code/data1000gt/";
        String treename = "Reti1_A";

        if(treename.startsWith("R")) {
            String stpath = path+treename + "/rooted_astral_tre_0.tre";
            String gtpath = path+treename  + "/rgts_0.tre";
            String outpath = path+treename  + "/ML.txt";
            String mapfile = path + "/iqmap.txt";
            inferML mlinfer = new inferML();
            String resultString = mlinfer.produceResult(gtpath, stpath, mapfile, "Z_0", "Z", mode);
            System.out.println(resultString);
            String filepath = path+treename  + "/MLresult.txt";
            treeRoot.StringToFile(resultString, filepath);
        }
    }
...
//            else if(mode == 3){
//                modename = "MAX";
//                mlinfer.setMaxReticulations(truepath, treename, trinetname);
//                System.out.println(treename+" : "+trinetname);
//            }
//            else if(mode == 4){
//                modename = "4";
//                mlinfer.setMaxReticulations(max);
//            }
//
//            String resultString = mlinfer.produceResult(gtpath, stpath, mapfile, "", "", mode);
//            System.out.println(resultString);
//            String filepath = path + treename+"/subgt/" + trinetname + "/ML"+ modename+num +"_result.txt";
//            treeRoot.StringToFile(resultString, filepath);
//        }
//    }
//
...
//            String resultString = mlinfer.produceResult(gtpath, stpath, mapfile, "", "", mode);
//            System.out.println(resultString);
//            String filepath = path + treename+"/subgt/" + trinetname + "/ML"+ modename +"_result.txt";
//            treeRoot.StringToFile(resultString, filepath);
//        }
//    }
