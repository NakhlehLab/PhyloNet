...
//import edu.rice.cs.bioinfo.programs.phylonet.algos.network.InferILSNetworkProbabilistically4;
...
// */
//@CommandName("infernetwork_ML4")
//public class InferNetwork_Probabilistic4 extends CommandBaseFileOut{
...
//
//
//    public InferNetwork_Probabilistic4(SyntaxCommand motivatingCommand, ArrayList<Parameter> params,
...
//            {
//                _usingBL = true;
//            }  Note: Cross validation does not apply to with branch length cases */
//
//            noError = noError && checkForUnknownSwitches("a","b","s","m","n","d","p","l","r","i","t","di","f");
//            checkAndSetOutFile(aParam, bParam, sParam, mParam, nParam, dParam, pParam, lParam, rParam, iParam,tParam,diParam,fParam);
//        }
//
//        return  noError;
//    }
...
//        // the old no branch length route
//            InferILSNetworkProbabilistically4 inference = new InferILSNetworkProbabilistically4();
//            inference.setSearchParameter(_maxRounds, _maxTryPerBranch, _improvementThreshold, _maxBranchLength,
//                    _Brent1, _Brent2, _maxExaminations, _maxFailure, _maxDiameter, speciesNetwork);
