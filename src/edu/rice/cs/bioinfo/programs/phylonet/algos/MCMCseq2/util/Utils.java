...
public class Utils {
    ...
    public static boolean _OUTPUTPROB = false;
    // inference
...
//    public static double _POISSON_PARAM = 0.6954260163; //median 1
...
//    public static double _GAMMA_MEAN_LOWER_BOUND = 0.00232;
    ...
    public static double _POP_SIZE_MEAN = 0.04;
