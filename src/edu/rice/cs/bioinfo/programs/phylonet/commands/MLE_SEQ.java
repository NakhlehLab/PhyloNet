 ...
 */
@CommandName("MLE_SEQ")
public class MLE_SEQ extends CommandBaseFileOutMultilocusData {
    ...
    public MLE_SEQ(SyntaxCommand motivatingCommand, ArrayList<Parameter> params,
...
//            conv.generateTracePlot();
        ...
        MLOptimizer mle = new MLOptimizer(alignments);
        mle.run();
