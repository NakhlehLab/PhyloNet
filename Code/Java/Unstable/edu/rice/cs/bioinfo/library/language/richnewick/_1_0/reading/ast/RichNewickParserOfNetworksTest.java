 ...
 */
public abstract class RichNewickParserOfNetworksTest<N extends Networks>
{
    protected abstract RichNewickParser<N> makeParser();
    ...
    public void testNetworks() throws Exception
    {
        ...
        // test the string "R;"
        network = SingleNetwork(makeParser().parse(toInputStream("R;")));
        ...
        // test the string "R;G;"
        Networks networks = makeParser().parse(toInputStream("R;G;"));
        ...
        network = SingleNetwork(makeParser().parse(toInputStream("R_A;")));
        ...
        // test the string "9A9;"
        network = SingleNetwork(makeParser().parse(toInputStream("9A9;")));
        AssertNodeLabelOnly("9A9", 1, 0, network.PrincipleInfo);
        Assert.assertEquals(false, network.PrincipleDescendants.Subtrees.iterator().hasNext());

        // test the string "'Dogs'' tails wag';"
        network = SingleNetwork(makeParser().parse(toInputStream("'Dogs'' tails wag';")));
        AssertNodeLabelOnly("Dogs' tails wag", 1, 0, network.PrincipleInfo);
        Assert.assertEquals(false, network.PrincipleDescendants.Subtrees.iterator().hasNext());


        // test the string "(A,B)R;"
        network = SingleNetwork(makeParser().parse(toInputStream("(A,B)R;")));
        ...
        network = SingleNetwork(makeParser().parse(toInputStream("(A,(B1,B2)B)R;")));
        ...
        network = SingleNetwork(makeParser().parse(toInputStream("R#H0;")));
        ...
        network = SingleNetwork(makeParser().parse(toInputStream("R#H0:1:2:3;")));
        Assert.assertEquals("R", ((NodeLabelNonEmpty)network.PrincipleInfo.NodeLabel).Label.Content);
        Assert.assertEquals("0", ((HybridNodeQualifierWithType)network.PrincipleInfo.HybridNodeQualifier).HybridNodeIndex.Content);
        Assert.assertEquals("H", ((HybridNodeQualifierWithType)network.PrincipleInfo.HybridNodeQualifier).HybridNodeType.Content);
        ...
        // test the string "[&R]R;"
        network = SingleNetwork(makeParser().parse(toInputStream("[&R]R;")));
        ...
        network = SingleNetwork(makeParser().parse(toInputStream("'This is the only node.';")));
        AssertNodeLabelOnly("This is the only node.", 1, 0, network.PrincipleInfo);
        Assert.assertEquals(false, network.PrincipleDescendants.Subtrees.iterator().hasNext());

        // test the string ";"
        network = SingleNetwork(makeParser().parse(toInputStream(";")));
        ...
        network = SingleNetwork(makeParser().parse(toInputStream("((1, ((2, (3, (4)Y#H1)g)e, (((Y#H1, 5)h, 6)f)X#H2)c)a, ((X#H2, 7)d, 8)b)r;")));
    ...
    protected void AssertNodeLabelOnly(String expectedNodeLabel, int lineNumber, int columnNumber, NetworkInfo info)
    {
