...
/*
 *@ClassName: decomposedTrees2
 *@Description:
 *@Author: Zhen Cao
 *@Date:  2019-07-28 15:54
 *@Version: 1.0
 */
...
public class decomposedTrees2 {
    ...
    public static Map<Network, Double> summarize(Map<Network, Double> networkMap){
        ...
        for(Network network: networkMap.keySet()){
            ...
            //todo:rename all networks in networkset
     ...
     * @Description:
     * @Param: network
     * @return: k+1 trees, k is #reti. each tree doesn't have the reti as leaf
     * @Author: Zhen Cao
     * @Date: 2019-07-29
     */
    ...
    public static Set<Network> NetworkPartition(Network<Integer> network){
        ...
        System.out.println("original:"+ network.toString());
