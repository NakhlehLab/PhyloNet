 ...
 */
public class NetworkFromGTTTwoStageSinglePerLocusState<T> extends NetworkFromGTTTwoStageState {

    public NetworkFromGTTTwoStageSinglePerLocusState(Network start,
        ...
        this._pseudoCalculation = new GTTPseudoLikelihood_SinglePerLocus();
        processGeneTrees();
