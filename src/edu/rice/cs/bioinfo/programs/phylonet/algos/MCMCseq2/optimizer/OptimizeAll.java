package edu.rice.cs.bioinfo.programs.phylonet.algos.MCMCseq2.optimizer;

import edu.rice.cs.bioinfo.library.programming.Container;
import edu.rice.cs.bioinfo.library.programming.Proc;
import edu.rice.cs.bioinfo.programs.phylonet.algos.MCMCseq2.move.network.param.ChangeTime;
...
public class OptimizeAll extends NetworkOperator {
    ...
    protected double _improvementThreshold = 0.0001;
    ...
    public double propose() {
        ...
        Randomizer.setSeed((int)(10000000 * Math.random()));

        boolean continueRounds = true;
        double initialProb = _state.calculateLikelihood();
                    ...
                    public void execute()
                    {
                        UnivariateFunction functionToOptimize = new UnivariateFunction() {
                            public double value(double suggestedProb) {
                                ...
                                double lnProb =  _state.calculateLikelihood();
