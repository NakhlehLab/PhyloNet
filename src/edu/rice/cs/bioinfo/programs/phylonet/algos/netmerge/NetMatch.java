...
//
//    private Network backboneTree = null;
//
//    /* Constructor */
////    public NetMatch(String distPath, String netPath) {
////        readMatrix(distPath);
...
////    }
////    public NetMatch(String distPath, List<Network> subnetlist){
////        readMatrix(distPath);
...
////        }
////    }
////    public NetMatch(double[][] matrix, List<Network> subnetlist, List<String> taxonList){
////        _matrix = matrix;
////        for (Network subnet: subnetlist){
////            List<Network> tmp = new ArrayList<>();
////            tmp.add(subnet);
...
////    }
//
//    public NetMatch(List<Network> subnetlist, List<String> taxonList, Network backboneTree){
//        for (Network subnet: subnetlist){
//            List<Network> tmp = new ArrayList<>();
//            tmp.add(subnet);
//            _subnetworks.add(tmp);
//        }
//        _taxonList = taxonList;
//        this.backboneTree = backboneTree;
//    }
//
//
//
...
////    }
//
//    public List<Network> matchPairs(){
