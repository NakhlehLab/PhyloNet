 ...
 * Date: 1/22/18
 *
 * Based on InferNetwork_MP by Yun Yu
 */
@CommandName("infernetwork_NCM")
public class InferNetwork_NCM extends CommandBaseFileOut{
...
//    private double _blParam = Double.POSITIVE_INFINITY;
    private double _blParam = 1;

    public InferNetwork_NCM(SyntaxCommand motivatingCommand, ArrayList<Parameter> params,
        ...
        if(noError)
        {
            ...
            if(plParam.ContainsSwitch){
                if(plParam.PostSwitchParam != null)
                {
                    ...
                    {
                        errorDetected.execute("Unrecognized number of processors " + plParam.PostSwitchValue, plParam.PostSwitchParam.getLine(), plParam.PostSwitchParam.getColumn());
                    }
                }
                else
                {
            ...
            if(blParam.ContainsSwitch)
            {
                if(blParam.PostSwitchParam != null)
                {
                    ...
                    {
                        errorDetected.execute("Unrecognized branch length param." + blParam.PostSwitchValue, blParam.PostSwitchParam.getLine(), blParam.PostSwitchParam.getColumn());
                    }
                }
                else
                {
            ...
            noError = noError && checkForUnknownSwitches("a","b","bl","s","n", "m", "md", "rd", "di", "h","f","pl","x","rs","w");
            checkAndSetOutFile(aParam, bParam, blParam, sParam, nParam, mParam, mdParam, rdParam, diParam, hParam, fParam, plParam,xParam,rsParam,wParam);
        }
