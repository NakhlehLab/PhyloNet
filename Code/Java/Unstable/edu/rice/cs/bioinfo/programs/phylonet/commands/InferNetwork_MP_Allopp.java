...
import edu.rice.cs.bioinfo.programs.phylonet.algos.polyploid.InferAlloppNetMP;
 ...
 */
@CommandName("infernetwork_mp_allopp")
public class InferNetwork_MP_Allopp extends CommandBaseFileOut{
    ...
    public InferNetwork_MP_Allopp(SyntaxCommand motivatingCommand, ArrayList<Parameter> params,
    ...
    @Override
    protected int getMinNumParams() { return 2; }

    @Override
    protected int getMaxNumParams() { return 25; }
    ...
    protected String produceResult() {
        ...
        InferAlloppNetMP inference = new InferAlloppNetMP();
        ...
        List<Tuple<Network, Double>> resultTuples = inference.inferNetwork(tuples, _species2alleles, _allele2species, _maxReticulations, _returnNetworks);
        int index = 1;
