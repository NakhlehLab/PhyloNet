...
import edu.rice.cs.bioinfo.programs.phylonet.algos.MCMCseq2.util.Tools;
...
//        Utils._POP_SIZE_MEAN = 0.4;
        ...
        Utils._OUT_DIRECTORY = basePath + "MCMCseq2/" + String.valueOf(lociSetId) + "_" + String.valueOf(seedID) + "/";
