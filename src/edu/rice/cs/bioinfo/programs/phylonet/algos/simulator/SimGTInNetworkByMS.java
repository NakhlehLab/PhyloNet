 ...
 * Time: 10:47 AM
 *
 * This class is for using ms (an external software package) to simulate gene trees within branches of a given species networks
 * Note that the network needs to be ultrametric
 */
