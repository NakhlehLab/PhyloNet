 ...
 */
public class NetworkFromGTTTwoStageMultiPerLocusState<T> extends NetworkFromGTTTwoStageState {

    public NetworkFromGTTTwoStageMultiPerLocusState(Network start,
        ...
        this._calculation = new GTTLikelihood_MultiPerLocus();
        this._pseudoCalculation = new GTTPseudoLikelihood_MultiPerLocus();
        processGeneTrees();
