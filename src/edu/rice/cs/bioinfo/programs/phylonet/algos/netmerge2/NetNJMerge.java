        ...
        for (int i = 0; i < n; i ++ ){
            for (int j = 0; j < n; j++){
                try {
                    ...
                    System.err.println(taxonList);
                    System.err.println(taxonIndexList);
                    System.err.println(taxonList.size()+","+taxonIndexList.size());
                    System.err.println(taxonList);
                    System.err.println(taxonIndexList);

                    System.err.println(_matrix.length);
