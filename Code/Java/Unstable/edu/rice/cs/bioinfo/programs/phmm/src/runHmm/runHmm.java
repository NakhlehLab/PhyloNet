...
public class runHmm {
	...
	private static String treesFileName = null;				/* Trees file name */
			
	
	// information created/built
	public static ArrayList<EvoTree> trees_states;			/* List of all states/trees */
	...
	public static void main(String[] args) throws Exception{
		...
		case 0: 
			...
			System.out.println("\nInput the trees (states) file path name:\n (note: see README for file format) \n");
			treesFileName = in.readLine();
	...
	private static void buildTrees() throws Exception {
		if (treesFileName != null) {
			System.out.println("\nNow building trees . . .");
			BufferedReader treesbr = new BufferedReader(new FileReader(treesFileName));
	        TreeParser tp = new TreeParser(treesbr);
	        trees_states = tp.nexusFileTreeNames(treesFileName);
...
//	        }
	        // <------Testing purposes
		} else throw new ParserFileException("Cannot read Trees file!");
	}
