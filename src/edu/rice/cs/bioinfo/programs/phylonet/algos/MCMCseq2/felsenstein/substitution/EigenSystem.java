package edu.rice.cs.bioinfo.programs.phylonet.algos.MCMCseq2.felsenstein.substitution;
 ...
 * Adapted from
 * https://github.com/CompEvol/beast2/blob/master/src/beast/evolution/substitutionmodel/DefaultEigenSystem.java
 */
public class EigenSystem {
    ...
    private double[][] Evec; // eigenvectors
    private double[][] Ievc; // inverse eigenvectors
    private int[] ordr;
    private double[] evali; // imaginary part of eigenvalues

    public EigenSystem(int stateCount) {
    ...
    /**
     * Sets instantaneous rate matrix.
     */
        ...
        while (en >= low) {    /* search for next eigenvalues */
            ...
            while (en >= 1) {
                ...
                if (itn == 0) {
                    ...
                    System.err.println("Eigenvalues not converged for Q-matrix");
                    for (i = 0; i < n; i++) {
                        System.err.println(Arrays.toString(h[i]));
                    }
